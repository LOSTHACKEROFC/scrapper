...
async def send_messages():
    # Inicia el bot
    bot = aiogram.Bot(token='7502171540:AAG9byU7X650NnQVeP-Z0GF8ECpQPaH-BK0')
    chat_id = -1002473487588
    ...
    for i, line in enumerate(lines, start=1):
        ...
        message = ""
        message += f"\n"
        message += f" GALAXY CARDER Scrapper 🐍"
        message += "━━━━━━━━━━━━━━\n"
        ...
        message += f"⌖  MADE BY ⤳ GALAXY CARDER\n"
        message += "━━━━━━━━━━━━━━\n"
